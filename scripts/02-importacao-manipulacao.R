...
# salva os dados limpos em um arquivo rds para análise futuras sem precisar 
# repetir a preparação dos dados
...
dados_vendas_limpos |> select(cidade, produto, receita)

# remove as colunas representante e cidade
dados_vendas_limpos |> 
  select(-representante, -cidade)

# salvando o resultadoem um novo objeto
...
# cria a variável preco_descoto (10% sobre o preco_unitario)
dados_vendas_limpos |> 
