...
# transforma o desempenho para o formato longo
...
# Combinando vendas e produtos usando left_join()
...
# Desafio: bine as 3 tabelas com um unico pipeline usando left_join() e veja o
# resultado usando a função View()
